...
#TEXTBOX6 BRINGS THE RESULT OF THE SECGROUP SEARCH
...
$textBox7.Location  = New-Object System.Drawing.Point(360,130)
...
#LABEL4 BRINGS BACK THE RESULT ID THE USER IS ON THE FIRST DOMAIN
...
#LABEL5 BRINGS BACK THE gridview

#$Label5 = New-Object System.Windows.Forms.label

#$Label5.Text = ""

#$Label5.Location  = New-Object System.Drawing.Point(355,105)#
...
#LABEL7 BRINGS BACK THE RESULT OF THE SECURUTY GROUP CHECK 
...
$button6.location =  New-Object System.Drawing.Point(350,100)
...
#BUTTON6 FOR THE LOOKFORIT



$button5 = new-object system.windows.forms.button

$button5.Location =  New-Object System.Drawing.Point(500,100)

$button5.width = 110

$button5.text = "look for it"
...
# name check
 ...
 $Label4.Text =  if( get-aduser -server $dom1 -f{name -like $name}) {get-aduser -server $dom1 -f{name -like $name} -properties * | select SamAccountName, mail, lockedout, enabled,  passwordexpired, passwordlastset, lastLogonDate, PrimaryGroup | fl | out-string } 

 else {get-aduser -server $dom2 -f{name -like $name} -properties * | select SamAccountName, mail, lockedout, enabled,  passwordexpired, passwordlastset, lastLogonDate,    PrimaryGroup | fl | out-string } 
...
$Label4.Text = if( get-aduser -server $dom1 -f{SamAccountName -like $userName}) {get-aduser -server $dom1 -f{SamAccountName -like $userName} -properties * | select SamAccountName, mail, lockedout, enabled,  passwordexpired, passwordlastset, lastLogonDate, PrimaryGroup | fl | out-string } 

 else {get-aduser -server $dom2 -f{SamAccountName -like $userName} -properties * | select SamAccountName, mail, lockedout, enabled,  passwordexpired, passwordlastset, lastLogonDate,    PrimaryGroup | fl | out-string } 
